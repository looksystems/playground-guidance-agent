...
(async () => {
  ...
  try {
    ...
    try {
      await page.click('div:has-text("Memory Type") button', { timeout: 5000 });
      await page.waitForTimeout(500);
      console.log('✓ Memory Type filter clicked');
    } catch (e) {
      console.log('⚠️ Could not click Memory Type filter');
    }
    ...
    try {
      ...
      console.log('⚠️ Could not click Clear filters button');
    }
