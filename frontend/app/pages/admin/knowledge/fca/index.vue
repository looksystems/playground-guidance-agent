  ...
  <ClientOnly>
    <div class="space-y-6">
      ...
      <div class="mb-6">
        ...
        <p class="text-gray-600 mt-2">Browse and search FCA compliance knowledge</p>
      </div>
        ...
        <UCard>
          <div class="flex items-start justify-between">
            ...
            <div class="p-3 bg-blue-50 rounded-lg">
              <UIcon name="i-heroicons-book-open-solid" class="w-6 h-6 text-blue-600" />
            </div>
          </div>
        </UCard>
      ...
      <div v-if="pending" class="flex items-center justify-center py-12">
        <div class="text-center">
          ...
          <p class="mt-4 text-gray-600">Loading FCA knowledge...</p>
        </div>
      </div>
