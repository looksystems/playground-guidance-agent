  ...
  <div>
    ...
    <div class="mb-6">
      ...
      <div class="flex items-center gap-2 mt-4">
        ...
        <UButton to="/admin/knowledge/pension" variant="ghost" size="xs" color="indigo">Pension Knowledge</UButton>
        <span class="text-gray-400">/</span>
    ...
    <div v-else class="space-y-6">
      ...
      <UCard v-if="item.subcategory">
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center gap-2">
            <UIcon name="i-heroicons-tag" class="w-5 h-5 text-gray-400" />
            <span class="text-gray-700 dark:text-gray-300">Subcategory:</span>
            <UButton
